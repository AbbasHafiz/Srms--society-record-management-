...
const DOC_TYPES = Object.values({
  ...
  POA_INSTRUMENT: "POA_INSTRUMENT",
  POA_TEHSILDAR_CERTIFICATE: "POA_TEHSILDAR_CERTIFICATE",
  POA_FOREIGN_OFFICE_ATTESTATION: "POA_FOREIGN_OFFICE_ATTESTATION",
  POA_ATTORNEY_CNIC: "POA_ATTORNEY_CNIC",
  POA_PLOT_DOCUMENTS: "POA_PLOT_DOCUMENTS",
  SIGNATURE: "SIGNATURE",
